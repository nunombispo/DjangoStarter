...
# Logging settings
log_app = config('LOG_APP')
log_module = config('LOG_MODULE')
log_level = config('LOG_LEVEL')
log_address = config('LOG_ADDRESS')
log_port = int(config('LOG_PORT'))
LOGGING = {
    'version': 1,
    ...
    'formatters': {
        'simple': {
            'format': f'%(asctime)s {log_app} %(module)s / %(funcName)s / %(levelno)s ==> %(message)s',
